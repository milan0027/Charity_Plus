  ...
  return (
    <div className='post bg-white p-1 my-1'>
      <div className='post-image-name'>
        ...
        <span className='post-heading-info hide-sm'>
          {post_event ? "Contribution" : "Comment"}
        </span>

        {post_event &&
          (approval ? (
            <span className='post-heading-approved hide-sm'>Approved</span>
          ) : (
            <span className='post-heading-pending hide-sm'>
              Pending Approval
            </span>
          ))}
      </div>
